...
referrer = input("ID Cloudflare: ")
timesToLoop = input("How Much: ")
retryTimes = 5
...
for i in range(int(timesToLoop)):
    ...
    if result.status_code == 200:
        print(i + 1, 'OK! [', moment.now().timezone("Asia/Jakarta").format("HH:mm:ss"), ']')
    else:
        print(i + 1, 'Error [', moment.now().timezone("Asia/Jakarta").format("HH:mm:ss"), ']')
